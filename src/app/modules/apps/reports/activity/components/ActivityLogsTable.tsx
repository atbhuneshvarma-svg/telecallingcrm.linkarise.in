...
export const ActivityLogsTable: React.FC<ActivityLogsTableProps> = ({
  ...
  const getActionBadgeClass = (action: string) => {
    ...
    switch (action) {
      case 'Login':
        return 'badge bg-success text-white px-2'

      case 'Edit':
        return 'badge bg-warning text-dark px-2'

      case 'Create':
        return 'badge bg-info text-white px-2'

      case 'Delete':
        return 'badge bg-danger text-white px-2'

      case 'Allocate':
        return 'badge bg-primary text-white px-2'

      case 'Import':
        return 'badge bg-warning text-white px-2'

      case 'Status Update':
        return 'badge bg-dark text-white px-2'

      case 'Transferred':
        return 'badge bg-info text-white px-2'

      default:
        return 'badge bg-light text-dark px-2'
    }
  };
